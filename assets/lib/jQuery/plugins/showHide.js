	    ...
	    .click(
		    function(){
			    ...
			    if ($(content).css("display") == "none") {			               
				    ...
				    $(this).html("<img src='images/icons/14-minus-ball.png' alt='Hide' />  <img src='images/icons/20-group.png' width='20' height='20' alt='Group' />");
				    ...
				    // set the spans inner text
				    $(this).html("<img src='images/icons/14-add-ball.png' alt='Show' /> <img src='images/icons/20-group.png' width='20' height='20' alt='Group' />");
